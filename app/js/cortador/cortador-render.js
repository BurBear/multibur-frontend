...
function ? renderActionButtons(process) ? {
 ...
 ?  ?  ?  ? ${toCortador
 ?  ?  ?  ?  ? ? ? "Ya ? terminaste ? los ? procesos ? de ? CORTADOR ? previos. ? Esta ? orden ? debe ? pasar ? a ? CORTE ? para ? continuar ? su ? ruta."
 ...
 ?  ? return ? `
 ?  ?  ? <div ? class="detail-actions">
 ?  ?  ?  ? <button ? class="btn ? btn-primary" ? type="button" ? data-cortador-action="start" ? ${disabled ? ? ? "disabled" ? : ? ""}>${text}</button>
 ?  ?  ? </div>
 ?  ? `;
 ? }
 ...
 ?  ? return ? `
 ?  ?  ? <div ? class="detail-actions">
 ?  ?  ?  ? <button ? class="btn ? btn-resume" ? type="button" ? data-cortador-action="resume" ? ${disabled ? ? ? "disabled" ? : ? ""}>${text}</button>
 ?  ?  ? </div>
 ?  ? `;
 ? }
 ...
 ?  ?  ? </div>
 ?  ?  ? <div ? class="detail-actions">
 ?  ?  ?  ? <button ? class="btn ? btn-warn" ? type="button" ? data-cortador-action="pause" ? ${ctx.busy ? ? ? "disabled" ? : ? ""}>${ctx.busyAction ? === ? "PAUSAR" ? ? ? "PAUSANDO..." ? : ? "PAUSAR"}</button>
 ?  ?  ?  ? <button ? class="btn ? btn-primary" ? type="button" ? data-cortador-action="finish" ? ${ctx.busy ? ? ? "disabled" ? : ? ""}>${ctx.busyAction ? === ? "FINALIZAR" ? ? ? "FINALIZANDO..." ? : ? "FINALIZAR"}</button>
 ?  ?  ? </div>
 ?  ? `;
 ? }
...
function ? renderMyProcesses() ? {
 ...
 ?  ?  ? <div ? class="mini-process-meta">${esc(process.cliente_nombre ? || ? "-")} ? ÃƒÂ¯Ã‚Â¿Ã‚Â½ ? ${esc(process.descripcion_trabajo ? || ? "-")}</div>
 ?  ? </button>
 ? `).join("");
}
...
function ? renderOrderCard(order) ? {
 ...
 ?  ?  ?  ?  ? Pendientes: ? ${progress.pendientes ? || ? 0} ? ÃƒÂ¯Ã‚Â¿Ã‚Â½ ? En ? proceso: ? ${progress.enProceso ? || ? 0} ? ÃƒÂ¯Ã‚Â¿Ã‚Â½ ? Pausados: ? ${progress.pausados ? || ? 0}
 ?  ?  ?  ? </div>
 ?  ?  ? </div>
...
function ? renderDetail() ? {
 ...
 ?  ?  ?  ?  ?  ?  ?  ? <button
 ?  ?  ?  ?  ?  ?  ?  ?  ? type="button"
 ?  ?  ?  ?  ?  ?  ?  ?  ? class="detail-process-item ? ${statusPillClass(item.estado)} ? ${Number(item.id) ? === ? Number(cortadorState.selectedProcessId) ? ? ? "is-current" ? : ? ""}"
 ?  ?  ?  ?  ?  ?  ?  ?  ? data-order-id="${order.orden_id}"
 ?  ?  ?  ?  ?  ?  ?  ?  ? data-process-id="${item.id}"
 ?  ?  ?  ?  ?  ?  ?  ? >
 ?  ?  ?  ?  ?  ?  ?  ?  ? <span>${esc(formatProcesoLabel(item))}</span>
 ?  ?  ?  ?  ?  ?  ?  ?  ? ${Number(item.id) ? === ? Number(cortadorState.selectedProcessId) ? ? ? '<span ? class="selected-badge">Seleccionado</span>' ? : ? ""}
